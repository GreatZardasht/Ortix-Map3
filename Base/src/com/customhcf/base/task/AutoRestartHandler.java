            ...
            public void run() {
                ...
                if ((remainingTicks = AutoRestartHandler.this.getRemainingTicks()) <= 0) {
                    ...
                    for (Player online : Bukkit.getOnlinePlayers()) {
                        online.kickPlayer((Object)ChatColor.YELLOW + "Server Restarting." + (reason == null ? "" : new StringBuilder().append((Object)ChatColor.AQUA).append("\n\n ").append(reason).toString()));
                    }
                    Bukkit.shutdown();
                    return;
                }
                ...
                if (Ints.contains((int[])ALERT_SECONDS, (int)((int)(remainingMillis / 1000)))) {
                    Bukkit.broadcastMessage((String)((Object)ChatColor.YELLOW + "Server restarting in " + (Object)ChatColor.AQUA + DurationFormatUtils.formatDurationWords((long)remainingMillis, (boolean)true, (boolean)true) + (Object)ChatColor.YELLOW + (reason == null || reason.isEmpty() ? "." : new StringBuilder().append(" [").append((Object)ChatColor.AQUA).append(reason).append((Object)ChatColor.YELLOW).append("].").toString())));
                }
            }
