...
import com.customhcf.hcf.listener.FactionsCoreListener;
                ...
                if (destroyed) {
                    ...
                    if (playerFaction != null) {
                        ...
                        if (informFaction) {
                            ...
                            playerFaction.broadcast(astrix + ChatColor.GREEN  + " has used a Crowbar de-activating one of the factions' end portals.", player.getUniqueId());
                        }
                    }
                }
