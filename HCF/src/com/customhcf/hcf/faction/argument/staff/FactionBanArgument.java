        ...
        extends CommandArgument
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        sender.sendMessage("§c§l[Server] §7Executing tempbans for the faction §c§l" + playerFaction.getName() + ".");
        sender.sendMessage("§c§lReason§7: §7" + extraArgs);
        sender.sendMessage(BukkitUtils.STRAIGHT_LINE_DEFAULT);
        Bukkit.getServer().broadcastMessage("§7The faction §c§l" + playerFaction.getName() + " §7has been tempban for §c§l" +extraArgs);
        return true;
    }
