...
TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 2 || !hasStaffPermission) {
            sender.sendMessage((Object)ChatColor.YELLOW + (sender.equals((Object)target) ? "Your balance" : new StringBuilder().append("Balance of ").append(target.getName()).toString()) + " is " + (Object)ChatColor.GREEN + '$' + balance + (Object)ChatColor.YELLOW + '.');
            return true;
        }
